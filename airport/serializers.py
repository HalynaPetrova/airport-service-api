...
from airport.models import Airport, AirplaneType, Airplane, Crew, Facility, Flight, Order, Route, Ticket
...
class AirplaneSerializer(serializers.ModelSerializer):
    class Meta:
        model = Airplane
        fields = ("id", "name", "airplane_type", "rows", "seats_in_row", "num_seats", "facilities", "crew", )
...
class CrewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Crew
        fields = ("id", "position", "first_name", "last_name", "airplanes", )
...
class AirplaneDetailSerializer(AirplaneSerializer):
    ...
    facilities = serializers.SlugRelatedField(
        ...
        read_only=True,
        slug_field="name",)
    crew = CrewAirplaneSerializer(many=True, read_only=True)
...
class FlightDetailSerializer(FlightSerializer):
    ...
    class Meta:
        model = Flight
        fields = ("id", "route", "departure_time", "arrival_time", "airplane", "taken_seats", )
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ("id", "created_at", "paid", "tickets",)
